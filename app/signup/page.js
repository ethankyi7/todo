...
export default function Signup() {
    return (
        ...
        <div className="bg-white rounded-lg shadow p-6" style={{ height: "475px", width: "400px", marginLeft: "250px" }}>
          <h1 className = {`flex justify-center items-center text-3xl`}>Sign Up</h1>
          ...
          <TextField fullWidth id="outlined-basic" label="confirm password" variant="outlined" margin = "normal" style={{ marginTop: "20px" }}/>
